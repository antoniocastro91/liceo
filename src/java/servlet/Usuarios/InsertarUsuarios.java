 ...
 */
@WebServlet(name = "InsertarUsuarios", urlPatterns = {"/Usuarios_Insertar"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             ...
             Integer id_rol = Integer.parseInt(request.getParameter("Rol"));
             Integer id_personal = Integer.parseInt(request.getParameter("Id_personal"));
              Usuario usuarios = new Usuario(usuario,clave,estado,id_rol, id_personal);
