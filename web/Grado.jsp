                           ...
                           <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                     <label for="name" class="cols-sm-3 control-label">Seccion</label>
                                        <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                                    <input type="text"  id="seccion" name="seccion" class="form-control" placeholder="Ingrese la Seccion"/>
                                         </div>
                             </div>
                                ...
                                <div>
                                 <button class="btn btn-default btn-lg btn-block" onclick="location.href='ListaGrado.jsp'">Mostrar</button>
                                </div> 
                </div>
            </div>
        </div>
